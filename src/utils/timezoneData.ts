...
const filterZoneByAbbr: any = (abbr: string, rtnText: boolean = true) => {
	let rtn: any = '';

	const arr: any[] = timezones().filter((row: any) => {
		return row.abbr == abbr; // should only return 1 record
	});
...
export { timezones, filterZoneByAbbr };
